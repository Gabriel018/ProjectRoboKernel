...
-- Vers&atilde;o do servidor: 10.1.39-MariaDB
-- vers&atilde;o do PHP: 7.3.5
...
(3, 'Marcos', '0999849439', '2019-03-14', '21220310', 'Estrada Coronel Vieira', '3232', '332', 'Iraj&atilde;¡', 'Rio de Janeiro', 'RJ', '434343', '44343', 'ana@gmail.com', '123', 'Jellyfish.jpg'),
(4, 'Duke', '4545454', '2019-03-11', '21220310', 'Estrada Coronel Vieira', '33', '3rrer', 'Iraj&atilde;¡', 'Rio de Janeiro', 'RJ', 'reerer', 'rere', 'ana@gmail.com', '123', ''),
(5, 'Antonia Maria ', '33232', '2019-03-19', '21220310', 'Estrada Coronel Vieira', 'ww', 'ww', 'Iraj&atilde;¡', 'Rio de Janeiro', 'RJ', 'eewew', 'ewew', 'ana@gmail.com', '123', 'aaca0f5eb4d2d98a6ce6dffa99f8254b.jpg'),
(6, 'Antonia Maria ', '089438438894', '2019-03-13', '21220310', 'Estrada Coronel Vieira', '333', '33', 'Iraj&atilde;¡', 'Rio de Janeiro', 'RJ', '4343434', '34433443', 'ana@gmail.com', '123', '61264f154350bdb13fc53dd5969f6d3a.jpg'),
(7, 'Antonia Maria ', '4545454', '2019-03-13', '21220310', 'Estrada Coronel Vieira', '122', '222', 'Iraj&atilde;¡', 'Rio de Janeiro', 'RJ', '4343434', 'ewew', 'marcos@gmail.com', '123', 'd1e6fd33016c4365a14d6970da07bf09.jpg');
...
--
ALTER TABLE `acesso_restrito`
  MODIFY `pk_restrito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;

--
-- AUTO_INCREMENT for table `cliente`
--
ALTER TABLE `cliente`
  MODIFY `codcliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;

--
-- AUTO_INCREMENT for table `funcionario`
--
ALTER TABLE `funcionario`
  MODIFY `codfuncionario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;

--
-- AUTO_INCREMENT for table `pedido`
--
ALTER TABLE `pedido`
  MODIFY `codpedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;

--
-- AUTO_INCREMENT for table `produto`
--
ALTER TABLE `produto`
  MODIFY `codproduto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
--
